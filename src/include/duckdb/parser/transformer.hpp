...
private:
	...
	unique_ptr<ParsedExpression> TransformPatternList(duckdb_libpgquery::PGList *list);
	unique_ptr<ParsedExpression> TransformPattern(duckdb_libpgquery::PGMatchRecognizePattern *pattern);
